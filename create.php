                            ...
                            <div class="frame-wrap">
                                <form action="handler.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="email" type="email" id="example-email-2" name="example-email-2" class="form-control" placeholder="Email">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="role" class="form-control" id="example-select">
                                            <option value="Пользователь">Обычный пользователь</option>
                                            <option value="Менеджер">Контент-менеджер</option>
                                    ...
                                    <div class="form-group">
                                        <button name="create_user" type="submit" class="btn btn-info">Добавить</button>
                                    </div>
                                </form>
                            </div>
                        </div>
